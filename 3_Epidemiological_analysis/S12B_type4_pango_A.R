...
metadata <- read.table(file = 'S9B_strains4.tsv', 
                       sep = '\t', header = TRUE, quote = "")
metadata2 <- read.table(file = 'S9B_metadata_ref.tsv', 
                        sep = '\t', header = TRUE, quote = "")
...
pdf(file = 'Output/S12B_tree_A.pdf', width = 4.4, height = 3)
print(p)
dev.off()
