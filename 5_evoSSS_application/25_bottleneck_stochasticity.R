...
load('bottleneck_stochasticity.Rdata')
...
ggplot(dfvar_all,  aes(x=h, y=seed, group = varlogfit, color = varlogfit)) +
  geom_smooth()
...
pdf(file = 'output/bottleneck_stochasticity.pdf', width = 2.65, height = 1.7)
print(p)
dev.off()
