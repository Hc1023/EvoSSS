...
pdf(paste0("Output/F6B_fluH5.pdf"), width = 4, height = 1.6)
print(p)
dev.off()
...
p2 =  ggplot() +
  ...
  coord_cartesian(xlim = c(as.Date('2021-09-01'), as.Date('2025-05-31')))
p2
pdf(paste0("Output/F6B_fluH5_prevalence.pdf"), width = 4, height = 1.2)
print(p2)
dev.off()
...
pdf(paste0("Output/F6B_fluH5_beta.pdf"), width = 3.3, height = 1.2)
print(p3)
dev.off()
