...
if(F){
  ...
  save(plot_data1, plot_data2, plot_data3, 
       file = 'F5A_pred_capacity.rdata')
}

load(file = 'F5A_pred_capacity.rdata')

p1 = plotfun(plot_data1 = plot_data1)
p2 = plotfun(plot_data1 = plot_data2)
p3 = plotfun(plot_data1 = plot_data3)
pdf(paste0("Output/F5A_pred_capacity.pdf"), 
    width = 2, height = 1.8)
print(p1)
print(p2)
print(p3)
