...
if(F){
  fitlist = list()
  save(fitlist, file = 'F6A_flu_2018.rdata')
  save(fitlist, plot_data, file = 'F6A_flu_2018.rdata')
  
}

load(file = 'F6A_flu_2018.rdata')
...
pdf(paste0("Output/F6A_flu_2018.pdf"), width = 4.4, height = 1.6)
print(p)
dev.off()
...
p4 = ggplot() +
  ...
  theme(plot.margin = unit(c(0.3,0.6,0,0.3), "cm"),
        panel.grid.minor = element_blank())
pdf(paste0("Output/F6A_flu_2018_par.pdf"), width = 4.3, height = 1)
print(p3)
print(p4)
dev.off()
