...
if(F){
  ...
  save(fitlistw, file = 'S12C_flu_2018_pred.rdata')
}
load('S12C_flu_2018_pred.rdata')
...
if(F){
  ...
  if(F){
    save(fitlistw, dataw, file = 'flu_2018_pred.rdata')
  }
  ...
  pdf(paste0("Output/S12C_pred_multiple_week.pdf"), width = 2.2, height = 2)
  print(p1)
  print(p2)
  dev.off()
}
