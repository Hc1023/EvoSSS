...
if(F){
  ...
  save(fitlist, file = 'evoSSS/AB_beta_mx10.rdata')
}
...
if(F){
  ...
  if(F){
    save(fitlist, simu_Onset, plot_data, file = 'evoSSS/AB_beta_mx10.rdata')
    load('evoSSS/AB_beta_mx10.rdata')
  }
...
pdf(paste0("Output/AB_plot_beta.pdf"), width = 2.58, height = 1.2)
print(p3)
dev.off()
