...
pdf(paste0("Output/S12A_fitting1.pdf"), width = 1.6, height = 1.3)
print(p)
dev.off()
...
p = ggplot() +
  ...
  theme(legend.position = 'none',
        ...
        panel.background = element_blank(),
        strip.background = element_blank())
pdf(paste0("Output/S12A_fitting2.pdf"), width = 1.4, height = 0.85)
print(p)
dev.off()
...
pdf(paste0("Output/S12A_fitting3.pdf"), width = 1.4, height = 0.85)
print(p)
dev.off()
...
p = ggplot() +
  ...
  theme(legend.position = 'none',
        ...
        panel.background = element_blank(),
        strip.background = element_blank())
pdf(paste0("Output/S12A_fitting4.pdf"), width = 1.6, height = 1.3)
print(p)
dev.off()
...
pdf(paste0("Output/S12A_fitting5.pdf"), width = 1.6, height = 1.3)
print(p)
dev.off()