...
realData_all <- read.csv("evoSIR/F4D_Covid19CasesWH.csv", row.names = 1)
...
p
pdf(paste0("Output/F4B_R0_delta.pdf"), width = 4.5, height = 1)
print(p)
dev.off()
...
pdf(paste0("Output/F4B_acrosshost_intro_beta.pdf"), width = 4.4, height = 1.3)
print(p)
dev.off()
