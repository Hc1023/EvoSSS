...
############ Amplicon Sequencing ########
load(file = 'S2_dilution_amplicon.Rdata')
...
pdf("Output/S2_dilution_amplicon.pdf", width = 10, height = 5)
print(ht_list)
dev.off()


############ Capture and Metagenomic Sequencing ########
load(file = 'S2_dilution_capture.Rdata')
...
pdf("Output/S2_dilution_capture.pdf", width = 10, height = 3)
print(ht_list)
dev.off()
